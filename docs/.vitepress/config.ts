    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            { text: 'Declaring a ViewSet', link: '/guide/vue-mixins#declaring-a-viewset-class' },
            { text: 'Mixins', link: '/guide/vue-mixins' },
            { text: 'Custom Endpoints', link: '/guide/vue-custom-endpoints' },
            { text: 'muxws client', link: '/guide/muxws#client' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'restViewSet / muxwsViewSet', link: '/api/viewset-factory' },
